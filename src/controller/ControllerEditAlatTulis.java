...
import controller.ControllerEditBuku;
 ...
 * @author Rendy
 */
public class ControllerEditAlatTulis {

    private ViewEditAlatTulis view;
    private Alat_tulis model;

    ControllerBeranda cb = new ControllerBeranda(new ViewBeranda());
    
    public ControllerEditAlatTulis(ViewEditAlatTulis view) {
        this.view = view;
